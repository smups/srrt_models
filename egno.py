...
################################################################################
array1 = anguelova.evaluate(args, *extent, N_x0 = N_r, N_x1 = N_θ, order='exact')
array2 = anguelova.evaluate(args, *extent, N_x0 = N_r, N_x1 = N_θ, order='leading')
np.save("./out/egno_exact.npy", array1)
np.save("./out/egno_leading.npy", array2)
del array1, array2
